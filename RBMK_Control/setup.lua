...
if component.isAvailable("internet") then
	...
	shell.execute("wget", nil, "https://raw.githubusercontent.com/BallOfEnergy1/RBMK_Control/master/RBMK_Control/funclib.lua", "/lib/funclib.lua", "-f")
	shell.execute("wget", nil, "https://raw.githubusercontent.com/BallOfEnergy1/RBMK_Control/master/RBMK_Control/RBMK_Monitor.lua", "/RBMK_Control/RBMK_Monitor.lua", "-f")
	shell.execute("wget", nil, "https://raw.githubusercontent.com/BallOfEnergy1/RBMK_Control/master/RBMK_Control/README.txt", "/RBMK_Control/README.txt", "-f")
