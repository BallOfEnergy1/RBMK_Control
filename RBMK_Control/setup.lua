...
if component.isAvailable("internet") then
	...
	shell.execute("wget", nil, "https://raw.githubusercontent.com/kitsunies/switch.lua/master/switch.lua", "/lib/funclib.lua", "-f")
	shell.execute("wget", nil, "https://raw.githubusercontent.com/BallOfEnergy1/OC_LUA/master/RBMK_Monitor_V2.lua", "/RBMK_Control/RBMK_Monitor.lua", "-f")
	shell.execute("wget", nil, "https://raw.githubusercontent.com/BallOfEnergy1/OC_LUA/master/README.txt", "/RBMK_Control/README.txt", "-f")
